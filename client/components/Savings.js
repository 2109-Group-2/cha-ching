...
class Savings extends Component {
  componentDidMount() {
    ...
    // console.log('component did mount goals: ')
  }

  render() {
    console.log("this is auth from props", this.props.auth.user);
    // console.log('this.props.auth: ',this.props);
    // try {
    //   this.props.fetchGoals(this.props.auth.user.id).then((res) => {
    //     let goal = res;
    //     console.log('this is the goal from inside render: ',goal)
    //   });
    //   // console.log("inside of render", goals);
    // } catch (error) {
    //   console.error("there was an error fetching goals", error);
    // }
    // const { user, savings } = this.props;
    // let totalAmount = 0;
    // goals.forEach((goal) => {
